...
// Plasmic Project: dqLQMj2mgc1torJkH4PSex
// Component: 3ASpt_MPyb0r
...
import projectcss from "./plasmic.module.css"; // plasmic-import: dqLQMj2mgc1torJkH4PSex/projectcss
import sty from "./PlasmicButton.module.css"; // plasmic-import: 3ASpt_MPyb0r/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: Si2CxvpNQGmm/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: Dqq70XAk0a5f/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__nfe7Z)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__kgNR)}
                role={"img"}
              />
            ),
